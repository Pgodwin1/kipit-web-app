    ...
    <div className="min-h-screen bg-white-100 flex flex-col">
      ...
      <div className="bg-gradient-to-r bg-[#101c4e] text-white px-6 py-8 rounded-b-3xl shadow-lg">
        ...
        <div className="flex items-center mt-6">
          ...
          />
          <div className="ml-4">
            <h2 className="text-lg text-white font-semibold">L. Ikeokwu</h2>
            <p className="text-sm text-white font-md">0810 175 6419</p>
            <p className="text-sm text-white font-md">loikeokwu@gmail.com</p>
          </div>
        </div>
      </div>

      {/* Options */}
      <div className="flex-1 bg-white shadow-lg pt-8 px-6">
        <ul className="space-y-6">
          <li className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <i className="fas fa-user text-orange-500"></i>
              <span className="text-gray-800 font-inter font-semibold" onClick={() => navigate("/personal-details")}>Personal Details</span>
            </div>
          ...
          <li className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-gray-800 font-semibold" onClick={() => navigate("/change-password")}>
                Privacy & Security
              </span>
            </div>
            <i className="fas fa-chevron-right text-gray-400"></i>
          ...
          <li className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-gray-800 font-semibold" onClick={handleDelete}>Logout</span>
            </div>
            <i className="fas fa-chevron-right text-gray-400"></i>
          </li>
        </ul>
